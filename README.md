...
- [raphamorim/rio](https://github.com/raphamorim/rio) ([v0.4.7](https://github.com/raphamorim/rio/releases/tag/v0.4.7), today) - A hardware-accelerated GPU terminal emulator focusing to run in desktops and browsers.
- [charmbracelet/catwalk](https://github.com/charmbracelet/catwalk) ([v0.44.17](https://github.com/charmbracelet/catwalk/releases/tag/v0.44.17), today) - 🐈 A collection of LLM inference providers and models 
