...
- [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ([v9.8.0](https://github.com/LazyVim/LazyVim/releases/tag/v9.8.0), today) - Neovim config for the lazy
...
- [rivo/uniseg](https://github.com/rivo/uniseg) - Unicode Text Segmentation, Word Wrapping, and String Width Calculation in Go (5 days ago)
