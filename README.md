...
- [raphamorim/rio](https://github.com/raphamorim/rio) ([v0.2.13](https://github.com/raphamorim/rio/releases/tag/v0.2.13), today) - A hardware-accelerated GPU terminal emulator focusing to run in desktops and browsers.
- [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) ([v2.0.0-beta.3](https://github.com/charmbracelet/bubbletea/releases/tag/v2.0.0-beta.3), 3 days ago) - A powerful little TUI framework 🏗
...
- [j4james/vtrex](https://github.com/j4james/vtrex) - An implementation of the Chrome dinosaur game for VT terminals. (6 days ago)
