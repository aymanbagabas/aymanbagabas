...
- [alacritty/vte](https://github.com/alacritty/vte) - Parser for virtual terminal emulators (1 day ago)
...
- [refactor: port wcwidth from elvish](https://github.com/charmbracelet/x/pull/337) on [charmbracelet/x](https://github.com/charmbracelet/x) (1 day ago)
- [refactor(ansi): mouse: don&#39;t export Button method](https://github.com/charmbracelet/x/pull/336) on [charmbracelet/x](https://github.com/charmbracelet/x) (2 days ago)
- [fix(input): kitty: handle ModShift|ModCapsLock as uppercase](https://github.com/charmbracelet/x/pull/335) on [charmbracelet/x](https://github.com/charmbracelet/x) (2 days ago)
- [feat(input): support parsing xterm window text area size report](https://github.com/charmbracelet/x/pull/334) on [charmbracelet/x](https://github.com/charmbracelet/x) (2 days ago)
- [fix(tea): set TERM environment variable when we have a PTY attached](https://github.com/charmbracelet/wish/pull/394) on [charmbracelet/wish](https://github.com/charmbracelet/wish) (3 days ago)
