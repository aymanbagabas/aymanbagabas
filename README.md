...
- [charmbracelet/crush](https://github.com/charmbracelet/crush) ([v0.51.1](https://github.com/charmbracelet/crush/releases/tag/v0.51.1), 1 day ago) - Glamourous agentic coding for all 💘
- [charmbracelet/catwalk](https://github.com/charmbracelet/catwalk) ([v0.30.8](https://github.com/charmbracelet/catwalk/releases/tag/v0.30.8), 1 day ago) - 🐈 A collection of LLM inference providers and models 
- [charmbracelet/soft-serve](https://github.com/charmbracelet/soft-serve) ([v0.11.6](https://github.com/charmbracelet/soft-serve/releases/tag/v0.11.6), 1 day ago) - The mighty, self-hostable Git server for the command line🍦
- [opt-nc/geol](https://github.com/opt-nc/geol) ([v2.10.0](https://github.com/opt-nc/geol/releases/tag/v2.10.0), 1 week ago) - Efficiently show and monitor end-of-life dates for a number of products in your terminal and CI using endoflife.date API
...
- [feat(bazarr): support yaml config and apikey field](https://github.com/onedr0p/exportarr/pull/427) on [onedr0p/exportarr](https://github.com/onedr0p/exportarr) (3 days ago)
- [feat: support extended keyboard enhancements](https://github.com/charmbracelet/bubbletea/pull/1626) on [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) (6 days ago)
