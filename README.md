...
- [charmbracelet/crush](https://github.com/charmbracelet/crush) ([v0.62.1](https://github.com/charmbracelet/crush/releases/tag/v0.62.1), today) - Glamourous agentic coding for all 💘
- [charmbracelet/catwalk](https://github.com/charmbracelet/catwalk) ([v0.37.14](https://github.com/charmbracelet/catwalk/releases/tag/v0.37.14), today) - 🐈 A collection of LLM inference providers and models 
...
- [internal: servers, add git server implementation](https://github.com/go-git/go-git/pull/2014) on [go-git/go-git](https://github.com/go-git/go-git) (today)
