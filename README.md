...
- [charmbracelet/catwalk](https://github.com/charmbracelet/catwalk) ([v0.7.0](https://github.com/charmbracelet/catwalk/releases/tag/v0.7.0), 2 days ago) - 🐈 A collection of LLM inference providers and models 
...
- [microsoft/terminal](https://github.com/microsoft/terminal) ([v1.24.2812.0](https://github.com/microsoft/terminal/releases/tag/v1.24.2812.0), 5 days ago) - The new Windows Terminal and the original Windows console host, all in the same place!

#### 🔨 My recent Pull Requests

- [feat: implement Stringer for StyledString](https://github.com/charmbracelet/ultraviolet/pull/53) on [charmbracelet/ultraviolet](https://github.com/charmbracelet/ultraviolet) (2 days ago)
- [feat(ansi): add DesktopNotification function for OSC 99](https://github.com/charmbracelet/x/pull/600) on [charmbracelet/x](https://github.com/charmbracelet/x) (2 days ago)
- [chore(ansi): add Notify function tests](https://github.com/charmbracelet/x/pull/599) on [charmbracelet/x](https://github.com/charmbracelet/x) (2 days ago)
- [refactor: introduce terminal lifecycle methods](https://github.com/charmbracelet/ultraviolet/pull/52) on [charmbracelet/ultraviolet](https://github.com/charmbracelet/ultraviolet) (2 days ago)
- [fix: renderer: add a trailing newline when exiting inline mode](https://github.com/charmbracelet/bubbletea/pull/1514) on [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) (3 days ago)
