...
- [aymanbagabas/uncurses](https://github.com/aymanbagabas/uncurses) - A terminal toolkit library for building UIs (6 days ago)
...
- [charmbracelet/catwalk](https://github.com/charmbracelet/catwalk) ([v0.51.11](https://github.com/charmbracelet/catwalk/releases/tag/v0.51.11), 1 day ago) - 🐈 A collection of LLM inference providers and models 
- [raphamorim/rio](https://github.com/raphamorim/rio) ([v0.5.5](https://github.com/raphamorim/rio/releases/tag/v0.5.5), 2 days ago) - A hardware-accelerated GPU terminal emulator focusing to run in desktops and browsers.
