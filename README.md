...
- [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ([v4.27.0](https://github.com/LazyVim/LazyVim/releases/tag/v4.27.0), 2 days ago) - Neovim config for the lazy
- [charmbracelet/vhs-action](https://github.com/charmbracelet/vhs-action) ([v2](https://github.com/charmbracelet/vhs-action/releases/tag/v2), 3 days ago) - Keep your GIFs up to date with VHS &#43; GitHub actions 📽️
...
- [feat(tests): support pure-go sqlite driver](https://github.com/go-gorm/gorm/pull/6448) on [go-gorm/gorm](https://github.com/go-gorm/gorm) (3 days ago)
- [feat: use pure-go implementation when cgo is disabled](https://github.com/go-gorm/sqlite/pull/161) on [go-gorm/sqlite](https://github.com/go-gorm/sqlite) (3 days ago)
