...
- [charmbracelet/log](https://github.com/charmbracelet/log) ([v0.2.3](https://github.com/charmbracelet/log/releases/tag/v0.2.3), 1 day ago) - A minimal, colorful Go logging library 🪵
- [golang/tools](https://github.com/golang/tools) ([gopls/v0.13.1](https://github.com/golang/tools/releases/tag/gopls/v0.13.1), 1 day ago) - [mirror] Go Tools
- [charmbracelet/pop](https://github.com/charmbracelet/pop) ([v0.2.0](https://github.com/charmbracelet/pop/releases/tag/v0.2.0), 1 day ago) - Send emails from your terminal 📬
...
- [feat,fix: add task manager](https://github.com/charmbracelet/soft-serve/pull/356) on [charmbracelet/soft-serve](https://github.com/charmbracelet/soft-serve) (today)
