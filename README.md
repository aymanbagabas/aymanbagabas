...
- [jayofelony/pwnagotchi](https://github.com/jayofelony/pwnagotchi) ([v2.9.4-2](https://github.com/jayofelony/pwnagotchi/releases/tag/v2.9.4-2), 4 days ago) - (⌐■_■) - Raspberry Pi instrumenting Bettercap for Wi-Fi pwning.
- [go-git/go-git](https://github.com/go-git/go-git) ([v5.13.1](https://github.com/go-git/go-git/releases/tag/v5.13.1), 4 days ago) - A highly extensible Git implementation in pure Go.
...
- [Merge v6-exp back into v6-transport](https://github.com/go-git/go-git/pull/1353) on [go-git/go-git](https://github.com/go-git/go-git) (2 days ago)
- [Merge v6-exp back into v6-transport](https://github.com/go-git/go-git/pull/1352) on [go-git/go-git](https://github.com/go-git/go-git) (2 days ago)
- [Update Privado VPN configurations](https://github.com/haugene/vpn-configs-contrib/pull/327) on [haugene/vpn-configs-contrib](https://github.com/haugene/vpn-configs-contrib) (3 days ago)
- [plumbing: transport, go check to testify migration](https://github.com/go-git/go-git/pull/1344) on [go-git/go-git](https://github.com/go-git/go-git) (5 days ago)
- [feat: initial commit](https://github.com/go-git/cli/pull/1) on [go-git/cli](https://github.com/go-git/cli) (6 days ago)
