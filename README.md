...
- [charmbracelet/catwalk](https://github.com/charmbracelet/catwalk) ([v0.44.15](https://github.com/charmbracelet/catwalk/releases/tag/v0.44.15), 1 day ago) - 🐈 A collection of LLM inference providers and models 
- [raphamorim/rio](https://github.com/raphamorim/rio) ([v0.4.6](https://github.com/raphamorim/rio/releases/tag/v0.4.6), 4 days ago) - A hardware-accelerated GPU terminal emulator focusing to run in desktops and browsers.
...
- [raphamorim/jamstation](https://github.com/raphamorim/jamstation) - A Playstation One (PS1) emulator fully written in Jam (2 days ago)
