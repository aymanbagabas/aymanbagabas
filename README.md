...
- [charmbracelet/vhs-action](https://github.com/charmbracelet/vhs-action) ([v2](https://github.com/charmbracelet/vhs-action/releases/tag/v2), 1 day ago) - Keep your GIFs up to date with VHS &#43; GitHub actions 📽️
- [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ([v4.25.1](https://github.com/LazyVim/LazyVim/releases/tag/v4.25.1), 2 days ago) - Neovim config for the lazy
...
- [feat(tests): support pure-go sqlite driver](https://github.com/go-gorm/gorm/pull/6448) on [go-gorm/gorm](https://github.com/go-gorm/gorm) (1 day ago)
- [feat: use pure-go implementation when cgo is disabled](https://github.com/go-gorm/sqlite/pull/161) on [go-gorm/sqlite](https://github.com/go-gorm/sqlite) (1 day ago)
- [Smart HTTP Git transport &amp; partial clones (#291)](https://github.com/charmbracelet/soft-serve/pull/332) on [charmbracelet/soft-serve](https://github.com/charmbracelet/soft-serve) (6 days ago)
