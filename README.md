...
- [charmbracelet/catwalk](https://github.com/charmbracelet/catwalk) ([v0.39.1](https://github.com/charmbracelet/catwalk/releases/tag/v0.39.1), today) - 🐈 A collection of LLM inference providers and models 
...
- [git: worktree, fix treeContainsDirs test to build a new tree for each…](https://github.com/go-git/go-git/pull/2047) on [go-git/go-git](https://github.com/go-git/go-git) (today)
