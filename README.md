...
- [charmbracelet/crush](https://github.com/charmbracelet/crush) ([v0.55.1](https://github.com/charmbracelet/crush/releases/tag/v0.55.1), today) - Glamourous agentic coding for all 💘
- [charmbracelet/catwalk](https://github.com/charmbracelet/catwalk) ([v0.34.4](https://github.com/charmbracelet/catwalk/releases/tag/v0.34.4), today) - 🐈 A collection of LLM inference providers and models 
...
- [PR 12: backend: unify git and http backends into single package](https://github.com/aymanbagabas/go-git/pull/16) on [aymanbagabas/go-git](https://github.com/aymanbagabas/go-git) (today)
