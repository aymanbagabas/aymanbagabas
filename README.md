...
- [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ([v6.3.0](https://github.com/LazyVim/LazyVim/releases/tag/v6.3.0), 4 days ago) - Neovim config for the lazy
...
- [refactor,fix: move parser to root and fix bugs](https://github.com/danielgatis/go-vte/pull/1) on [danielgatis/go-vte](https://github.com/danielgatis/go-vte) (3 days ago)
...
- [xo/terminfo](https://github.com/xo/terminfo) - A terminfo package in pure go! (1 day ago)
