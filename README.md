...
- [charmbracelet/crush](https://github.com/charmbracelet/crush) ([v0.1.11](https://github.com/charmbracelet/crush/releases/tag/v0.1.11), today) - The glamourous AI coding agent for your favourite terminal 💘
...
- [raphamorim/fuzzy](https://github.com/raphamorim/fuzzy) - fuzzy matching with Levenshtein, Damerau-Levenshtein, Bitap and n-gram (today)
