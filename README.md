...
- [charmbracelet/catwalk](https://github.com/charmbracelet/catwalk) ([v0.9.6](https://github.com/charmbracelet/catwalk/releases/tag/v0.9.6), 1 day ago) - 🐈 A collection of LLM inference providers and models 
- [charmbracelet/crush](https://github.com/charmbracelet/crush) ([v0.22.1](https://github.com/charmbracelet/crush/releases/tag/v0.22.1), 1 day ago) - The glamourous AI coding agent for your favourite terminal 💘
...
- [opt-nc/geol](https://github.com/opt-nc/geol) ([v2.0.1](https://github.com/opt-nc/geol/releases/tag/v2.0.1), 4 days ago) - Efficiently show end-of-life dates for a number of products in your terminal  using https://endoflife.date/ API
...
- [fix(ui): list highlight selection scrolling](https://github.com/charmbracelet/crush/pull/1575) on [charmbracelet/crush](https://github.com/charmbracelet/crush) (1 day ago)
- [docs: update rspamd arc domain dkim file path](https://github.com/docker-mailserver/docker-mailserver/pull/4616) on [docker-mailserver/docker-mailserver](https://github.com/docker-mailserver/docker-mailserver) (2 days ago)
- [perf(tui): debounce window resize rendering](https://github.com/charmbracelet/crush/pull/1556) on [charmbracelet/crush](https://github.com/charmbracelet/crush) (4 days ago)
- [fix(renderer): reset kitty keyboard protocol on alt screen switch](https://github.com/charmbracelet/bubbletea/pull/1554) on [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) (5 days ago)
...
- [antonmedv/gitmal](https://github.com/antonmedv/gitmal) - A static page generator for repos (2 days ago)
...
- [rockorager/prise](https://github.com/rockorager/prise) -  (4 days ago)
