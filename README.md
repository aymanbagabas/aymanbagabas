...
- [charmbracelet/crush](https://github.com/charmbracelet/crush) ([v0.21.0](https://github.com/charmbracelet/crush/releases/tag/v0.21.0), today) - The glamourous AI coding agent for your favourite terminal 💘
- [charmbracelet/catwalk](https://github.com/charmbracelet/catwalk) ([v0.9.5](https://github.com/charmbracelet/catwalk/releases/tag/v0.9.5), 2 days ago) - 🐈 A collection of LLM inference providers and models 
- [opt-nc/geol](https://github.com/opt-nc/geol) ([v2.0.1-develop.1](https://github.com/opt-nc/geol/releases/tag/v2.0.1-develop.1), 2 days ago) - Efficiently show end-of-life dates for a number of products in your terminal  using https://endoflife.date/ API
