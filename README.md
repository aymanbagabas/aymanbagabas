...
- [charmbracelet/catwalk](https://github.com/charmbracelet/catwalk) ([v0.7.0](https://github.com/charmbracelet/catwalk/releases/tag/v0.7.0), today) - 🐈 A collection of LLM inference providers and models 
- [raphamorim/rio](https://github.com/raphamorim/rio) ([v0.2.32](https://github.com/raphamorim/rio/releases/tag/v0.2.32), today) - A hardware-accelerated GPU terminal emulator focusing to run in desktops and browsers.
