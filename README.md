...
- [charmbracelet/crush](https://github.com/charmbracelet/crush) ([v0.9.2](https://github.com/charmbracelet/crush/releases/tag/v0.9.2), 1 day ago) - The glamourous AI coding agent for your favourite terminal 💘
- [charmbracelet/catwalk](https://github.com/charmbracelet/catwalk) ([v0.5.8](https://github.com/charmbracelet/catwalk/releases/tag/v0.5.8), 1 day ago) - 🐈 A collection of LLM inference providers and models 
...
- [fix(tui): yes/no init selection](https://github.com/charmbracelet/crush/pull/1074) on [charmbracelet/crush](https://github.com/charmbracelet/crush) (2 days ago)
- [windows: add FlushConsoleInputBuffer and GetNumberOfConsoleInputEvents](https://github.com/golang/sys/pull/264) on [golang/sys](https://github.com/golang/sys) (3 days ago)
- [fix: windows: always enable VT processing on Windows](https://github.com/charmbracelet/fang/pull/72) on [charmbracelet/fang](https://github.com/charmbracelet/fang) (5 days ago)
- [feat: add codecov coverage to all workflows](https://github.com/charmbracelet/x/pull/565) on [charmbracelet/x](https://github.com/charmbracelet/x) (5 days ago)
