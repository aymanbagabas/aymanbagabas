...
- [charmbracelet/keygen](https://github.com/charmbracelet/keygen) ([v0.5.4](https://github.com/charmbracelet/keygen/releases/tag/v0.5.4), 3 days ago) - An SSH key pair generator 🗝️
...
- [charmbracelet/fang](https://github.com/charmbracelet/fang) ([v0.4.3](https://github.com/charmbracelet/fang/releases/tag/v0.4.3), 5 days ago) - The CLI starter kit
- [charmbracelet/catwalk](https://github.com/charmbracelet/catwalk) ([v0.6.3](https://github.com/charmbracelet/catwalk/releases/tag/v0.6.3), 5 days ago) - 🐈 A collection of LLM inference providers and models 

#### 🔨 My recent Pull Requests

- [fix: protect output buffer with mutex](https://github.com/charmbracelet/bubbletea/pull/1502) on [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) (4 days ago)
- [(v2) Bubble Tea idiomatic Go API](https://github.com/charmbracelet/bubbletea/pull/1500) on [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) (5 days ago)
- [feat: add support for terminal progress bars](https://github.com/charmbracelet/bubbletea/pull/1499) on [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) (5 days ago)
