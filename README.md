...
- [raphamorim/rio](https://github.com/raphamorim/rio) ([v0.5.20](https://github.com/raphamorim/rio/releases/tag/v0.5.20), 1 day ago) - A hardware-accelerated GPU terminal emulator focusing to run in desktops and browsers.
- [charmbracelet/catwalk](https://github.com/charmbracelet/catwalk) ([v0.51.21](https://github.com/charmbracelet/catwalk/releases/tag/v0.51.21), 1 day ago) - 🐈 A collection of LLM inference providers and models 
