...
- [aymanbagabas/mopidy-mp3quran](https://github.com/aymanbagabas/mopidy-mp3quran) - A Mopidy extension for Mp3Quran (http://www.mp3quran.net/). (5 days ago)
...
- [raphamorim/rio](https://github.com/raphamorim/rio) ([v0.4.1](https://github.com/raphamorim/rio/releases/tag/v0.4.1), 1 day ago) - A hardware-accelerated GPU terminal emulator focusing to run in desktops and browsers.
...
- [charmbracelet/catwalk](https://github.com/charmbracelet/catwalk) ([v0.39.1](https://github.com/charmbracelet/catwalk/releases/tag/v0.39.1), 3 days ago) - 🐈 A collection of LLM inference providers and models 
- [microsoft/terminal](https://github.com/microsoft/terminal) ([v1.25.1171.0](https://github.com/microsoft/terminal/releases/tag/v1.25.1171.0), 4 days ago) - The new Windows Terminal and the original Windows console host, all in the same place!
- [aymanbagabas/mopidy-mp3quran](https://github.com/aymanbagabas/mopidy-mp3quran) ([v0.2.1](https://github.com/aymanbagabas/mopidy-mp3quran/releases/tag/v0.2.1), 5 days ago) - A Mopidy extension for Mp3Quran (http://www.mp3quran.net/).
