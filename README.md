...
- [opt-nc/geol](https://github.com/opt-nc/geol) ([v2.20.1-develop.1](https://github.com/opt-nc/geol/releases/tag/v2.20.1-develop.1), today) - Efficiently show and monitor end-of-life dates for a number of products in your terminal and CI using endoflife.date API
