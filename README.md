...
- [aymanbagabas/iosevka-fonts](https://github.com/aymanbagabas/iosevka-fonts) -  (4 days ago)
- [linrunner/TLP](https://github.com/linrunner/TLP) - TLP - Optimize Linux Laptop Battery Life (5 days ago)
...
- [linrunner/TLP](https://github.com/linrunner/TLP) ([1.4.0-beta.2](https://github.com/linrunner/TLP/releases/tag/1.4.0-beta.2), 2 days ago) - TLP - Optimize Linux Laptop Battery Life
- [libretro/retroarch-joypad-autoconfig](https://github.com/libretro/retroarch-joypad-autoconfig) ([v1.9.9](https://github.com/libretro/retroarch-joypad-autoconfig/releases/tag/v1.9.9), 5 days ago) - RetroArch joypad autoconfig files
...
- [bat.d (huawei) fix driver platform sysfs path](https://github.com/linrunner/TLP/pull/577) on [linrunner/TLP](https://github.com/linrunner/TLP) (5 days ago)
