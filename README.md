...
- [raphamorim/rio](https://github.com/raphamorim/rio) ([v0.5.21](https://github.com/raphamorim/rio/releases/tag/v0.5.21), today) - A hardware-accelerated GPU terminal emulator focusing to run in desktops and browsers.
- [charmbracelet/catwalk](https://github.com/charmbracelet/catwalk) ([v0.51.22](https://github.com/charmbracelet/catwalk/releases/tag/v0.51.22), today) - 🐈 A collection of LLM inference providers and models 
