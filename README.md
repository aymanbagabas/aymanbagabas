...
- [charmbracelet/catwalk](https://github.com/charmbracelet/catwalk) ([v0.9.5](https://github.com/charmbracelet/catwalk/releases/tag/v0.9.5), 1 day ago) - 🐈 A collection of LLM inference providers and models 
- [opt-nc/geol](https://github.com/opt-nc/geol) ([v2.0.1-develop.1](https://github.com/opt-nc/geol/releases/tag/v2.0.1-develop.1), 1 day ago) - Efficiently show end-of-life dates for a number of products in your terminal  using https://endoflife.date/ API
...
- [feat: implement text highlighting in list items](https://github.com/charmbracelet/crush/pull/1536) on [charmbracelet/crush](https://github.com/charmbracelet/crush) (2 days ago)
